...
const MakeupNew = () => {
	...
	return (
		<section>
			...
			<img
				className='new-makeup-img'
				src='https://s2.r29static.com/bin/entry/0e3/0,0,2000,1050/x,80/1716506/image.jpg'
				alt=''
			/>
			<br></br>
			<br></br>
